...
public class MovementLibrary : MonoBehaviour
{
    ...
    public static IEnumerator AnimationCurveLerp(GameObject obj, float duration, Vector3 startValue, Vector3 endValue, bool scaledTime, ObjectLerpType ObjectLerpType, AnimationCurve animationCurve, Action beginAction, Action middleAction, Action endAction)
    {
        //Check if it is a rotaiton. More efficient to make it its own function
        if (ObjectLerpType == ObjectLerpType.Rotation)
        {
    ...
    public static IEnumerator AnimationCurveLerp(GameObject obj, float duration, Vector3 startValue, Vector3 endValue, bool scaledTime, ObjectLerpType ObjectLerpType, AnimationCurve animationCurve)
    {
        //Check if it is a rotaiton. More efficient to make it its own function
        if (ObjectLerpType == ObjectLerpType.Rotation)
        {
