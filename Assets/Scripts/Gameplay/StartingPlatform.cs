...
public class StartingPlatform : MonoBehaviour
{
    ...
    public void TraverseTower()
    {
        ...
        moveCoroutine = StartCoroutine(MovementLibrary.AnimationCurveLerp(gameObject, speed, transform.position, target, false, MovementLibrary.ObjectLerpType.Position, traverseAnimCurve));
    }
