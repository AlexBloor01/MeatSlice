...
public class SettingsMenu : MonoBehaviour
{
    ...
    {
        StartCoroutine(MovementLibrary.AnimationCurveLerp(settingButton, lerpDuration, Vector3.one, Vector3.zero, false, MovementLibrary.ObjectLerpType.LocalScale, GameManager.iGameManager.btnAnimCurve));
    }

    //Animation for unhiding the settings button.
    public void UnhideSettingsButtonAnim()
    {
        StartCoroutine(MovementLibrary.AnimationCurveLerp(settingButton, lerpDuration, Vector3.zero, Vector3.one, false, MovementLibrary.ObjectLerpType.LocalScale, GameManager.iGameManager.btnAnimCurve));
    }
}
